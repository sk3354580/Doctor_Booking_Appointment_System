...
class rate(admin.ModelAdmin):
    list_display = ('id','doctorratingid','patientratingid','stars','recomend','title','description')
admin.site.register(Rating,rate)
class docreply(admin.ModelAdmin):
    list_display = ('id','reviews','doctor_reply_id','reply')
admin.site.register(doctor_reply,docreply)
class schedule(admin.ModelAdmin):
    list_display = ('id','schedule_doctor_id','schedule_time','schedule_day')
admin.site.register(doctor_schedule,schedule)
