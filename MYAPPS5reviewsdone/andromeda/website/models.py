...
############this are time slots created by doctorss
time_slots = (
...
class doctor_schedule(models.Model):
    schedule_doctor_id = models.ForeignKey(doctor_profile,on_delete=models.CASCADE)
    schedule_time = models.CharField(max_length=50, choices=time_slots)
    schedule_day = models.CharField(max_length=15, choices=DAYS_OF_WEEK)
