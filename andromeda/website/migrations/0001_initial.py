    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientId', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, related_name='patientId', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='doctor_profile',
            fields=[
                ...
                ('doctorId', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, related_name='doctorId', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_id', to='website.doctor_profile')),
                ('patient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patient_id', to='website.patient_profile')),
            ],
        ),
    ]
